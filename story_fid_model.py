...
class VideoResNet(nn.Module):
    ...
    def __init__(self, block, conv_makers, layers,
                 stem, avg_pool_layer=False, num_classes=400,
        ...
        self.output_avg_pool = avg_pool_layer
...
def r2plus1d_18(pretrained=False, progress=True, avg_pool_layer=False, **kwargs):
