...
if __name__ == "__main__":
	from .dataloader import ImageDataset, StoryDataset, video_transform
	...
	print(len(test_storydataset))
	fid_value = fid_score(IgnoreLabelDataset(test_storydataset),
		IgnoreLabelDataset(test_storydataset), cuda=True, normalize=True, r_cache='.cache/reference_score.npz'
		)
	print('FID : ', fid_value)
